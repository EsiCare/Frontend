 ...
 */
export class PatientHistoryDataSource extends DataSource<HistoryItem> {
   ...
   */
  private getPagedData(data: HistoryItem[]): HistoryItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: HistoryItem[]): HistoryItem[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        case 'name': return compare(a.patient, b.patient, isAsc);
